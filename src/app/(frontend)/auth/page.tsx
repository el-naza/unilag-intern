...
export default function Page() {
  return (
    <div className="text-white h-screen flex flex-col justify-between py-32 tracking-[0.37px]">
      <div className="px-4">
      ...
      <div className="px-[30px] text-center text-sm leading-6">
        <Link href="/auth/login">
          <Button size="lg" className="bg-white hover:bg-white/90 text-black1 w-full mb-3">
        ...
        <div className="text-[12px] text-gray-light02 leading-[16.5px]">
          Not a Registered Siwes Applicant? &nbsp;
          <Link href="/auth/sign-up">
            <Button variant="link" size="link" className="text-accent-orange">
              Sign up instead
            </Button>
          </Link>
        </div>
