...
const Footer = () => {
  return (
    <footer className="grid grid-cols-11 justify-evenly gap-8 bg-[#D2E6E4] text-primary pb-16 pt-24 px-24 text-[14px] w-full curved-top">
      <div className="lg:col-span-1 sm:col-span-3">
        <Image src={'/images/unilag-logo.png'} alt="Logo" width={60} height={100} />
      </div>

      <div className="lg:col-span-4 sm:col-span-5 mr-8">
