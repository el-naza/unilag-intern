        ...
        <main className="py-1 bg-white">
          <div>
            <div className="flex justify-between mt-3 mb-6">
              <div>
                <h5 className="text-black font-bold">Daily Report</h5>
              </div>
              <div>
            ...
            <div className="grid gap-4">
              ...
              <div className="">
                <h5 className="text-black mb-2">Report Title</h5>
                <input
              ...
              <div className="">
                <h5 className="text-black mb-2">Report Details</h5>
                <textarea
                  className="text-sm w-full placeholder:text-[#ECECEC] p-2 border border-[#F1F1F1] rounded mb-2"
                  rows={5}
                  placeholder="EWrite here..."
                ></textarea>
              </div>
              <div className="">
                <div className="grid grid-cols-3">
                  <button className="col-start-3 w-full rounded-lg p-3 bg-[#0B7077] text-white text-center">
                    Submit Task
                  </button>
                </div>
              </div>
