                  ...
                  <div className="lg:col-span-2 p-4">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="text-[#8E8E93] text-xs">
                        <p className="mb-2">
                          To apply for your SIWES placement at CMR Shopping Mall, applicants must
                          meet the following requirements:
                        </p>
                        <ul className="list-disc">
                          <li className="ms-4 mb-2">
                            Educational Background: Currently enrolled in a tertiary institution
                            (University, Polytechnic, or College of Education) and studying a
                            relevant course such as Business Administration, Marketing, Accounting,
                            or any related field.
                          </li>
                          <li className="ms-4 mb-2">
                            SIWES Eligibility: Must be approved for SIWES by your institution and
                            provide proof of eligibility, such as an SIWES introductory letter from
                            your school.
                          </li>
                        </ul>
                      </div>
