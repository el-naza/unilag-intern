                  ...
                  <div className="lg:col-span-2 p-4">
                    <div className="flex gap-2 items-center mb-3">
                      <Image
                        height={32}
                        width={32}
                        src={company.image ? company?.image?.url : '/company-logo.png'}
                        alt="company-logo"
                      />
                    ...
                    {company.firstInternship && (
                      <div className="grid grid-cols-2 gap-4 text-xs mb-4">
                        ...
                        <div className="grid grid-rows-1 gap-1">
                          ...
                          <div className="text-[#48484A]">
                            {company.firstInternship.courseArea
                              ? company.firstInternship.courseArea.join(', ')
                              : ''}
                          </div>
                        </div>
                        <div className="grid grid-rows-1 gap-1">
                    ...
                    <div className="grid grid-cols-3 mb-3">
                      ...
                      <div className="col-span-2">
                        <Dialog open={open} onOpenChange={setOpen}>
                          ...
                          <DialogContent className="bg-white rounded-lg gap-2 min-w-[400px]">
                                    ...
                                    <div>
                                      ...
                                      <div className="text-xs text-[#878787]">
                                        {internship?.jobDescription
                                          ? truncateText(internship?.jobDescription, 40)
                                          : ''}
                                      </div>
                                    </div>
                                    <div>
                    ...
                    <div className="mb-3">
                      ...
                      <div className="text-[#8E8E93] text-xs">
                        {company.firstInternship ? company.firstInternship.jobDescription : ''}
                      </div>
                    </div>
                    <div className="mb-3">
