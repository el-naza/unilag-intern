...
export default function SchoolCard({ id, schoolLogo, schoolName, motto, portal, availability }) {
  return (
    <div className="flex flex-col gap-y-6 py-5 px-[15px] bg-[#F5F9FF] border-solid border-[1px] border-[#DCDCDC] rounded-[6px] relative">
      ...
      <a
        href={portal}
        className={`bg-[#1E2763] py-3 px-5 rounded-[100px] text-white  text-xl font-normal leading-[1.5] ${jost.className} self-start text-center ${availability ? '' : 'cursor-not-allowed opacity-50'}`}
      >
        Go-to Portal
      </a>
      <Image
